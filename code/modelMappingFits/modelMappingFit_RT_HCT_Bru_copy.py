...
D_c2 = 2e-15 * m**2
llambda = 5.962e-04 # migration rate
D_p = 2e-9 * m**2
a = 25.91237399 # mmHg/s
og_a = 22.1 # mmHg/s
gamma = 8.360e-06 # 1/s
doubt_max = 100. # h
doubt_min = 17.1 # h
...
og_dr = 18.4e-6 * m
v0 = 0.95e-11 * m**3# m^3
epsilon = 9.375e-05 # rate hypox -> nec
delta = 4.400e-06 # rate nec clear
pcrit = 0 # mmHg
ph = 0.5 # mmHg
p0 = 120. # mmHg
...
p_therapy = np.array([0.25557359,0.67130001]) # p0 = 120
t_offset_rel = 0
#"""
...
therapyType = ""
filename = model + "_" + cellline + "_" + expFile + "_dr_12_1_1_p0_120" # dr_9 is skipped! 
