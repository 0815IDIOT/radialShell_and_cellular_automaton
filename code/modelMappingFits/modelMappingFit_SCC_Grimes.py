...
D_c2 = 2e-15 * m**2
llambda = 6e-4 / 10. # migration rate
D_p = 2e-9 * m**2
a = 11.21 # mmHg/s
og_a = a
gamma = 0. # 1/s
...
delta = 0.330070086 / 3600 / 24 # rate nec clear
#delta /= 100.
pcrit = 0 # mmHg
ph = 0.5 # mmHg
p0 = 100. # mmHg
...
expFile = "Gri2016_Fig4d_exp"
therapyType = ""
filename = model + "_" + cellline + "_dr_12_1"
